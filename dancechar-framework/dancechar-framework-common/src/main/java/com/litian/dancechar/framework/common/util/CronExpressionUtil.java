...
public final class CronExpressionUtil implements Serializable, Cloneable {
     ...
     * 验证cron表达式是否合法
     */
    public static boolean validCronExpression(String cron){
        try{
    ...
    public static void main(String[] args) {
        System.out.println(validCronExpression("0/2 * * * * ?"));
    }
